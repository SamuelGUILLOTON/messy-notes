    ...
    <div className={`flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 ${styleHome.signIn}`}>
        <h3 className={ styleHome.logo }>
          <span className={styleHome.logoContainer}>
            Mess<span className={styleHome.logoSpan} >y</span> notes 
          </span>
        </h3>
          ...
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                onClick={() => signup()}
                className={`disabled:opacity-40 flex w-full justify-center rounded-md  px-3 py-1.5 text-sm font-semibold leading-6  shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500 ${styleHome.bgColorDark}`}
              >
                Sign Up
              </button>
            </div>
